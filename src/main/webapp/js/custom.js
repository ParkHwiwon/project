...
$(document).ready(function(){
    ...
    $(".slide#first").backstretch("images/GwanganBridge2.jpg");
    $(".slide#sec").backstretch("images/InternationalMarket.jpeg");
    $(".slide#thirth").backstretch("images/GamcheonCultureVillage3.png");
    $(".slide#fourth").backstretch("images/Haeundae3.jpg");

    $('.slide .backstretch backgroundcolor').on('dragstart', function(event) { event.preventDefault(); });
